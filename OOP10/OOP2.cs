...
namespace OOP2
{
    class OOP2
    {
        ...
        //        vectors.Add(new Vector(99, 101));
        //        vectors.Add(new Vector(10, 0));
        //        vectors.Add(new Vector(20, 0));
        //        vectors.Add(new Vector(4, 4));
        //        vectors.Add(new Vector(5, 5));
        //        vectors.Add(new Vector(6, 6));
        //        vectors.Add(new Vector(7, 7));
        //    }
        //}
